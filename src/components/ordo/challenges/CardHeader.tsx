    ...
    <div className="flex flex-col gap-2.5">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="w-10 h-10 rounded-xl bg-muted/60 flex items-center justify-center border border-border shrink-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 text-xs font-medium text-muted-foreground flex-wrap">
              <span className={`inline-flex items-center gap-1 font-semibold ${catMeta.textClass}`}>
                <span
                  className={`w-1.5 h-1.5 rounded-full ${catMeta.dotClass}`}
                  aria-hidden="true"
                />
                {category}
              </span>
